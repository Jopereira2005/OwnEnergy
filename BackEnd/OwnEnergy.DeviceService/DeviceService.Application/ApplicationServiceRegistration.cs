...
public static class ApplicationServiceRegistration
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IDeviceSnapshotService, DeviceSnapshotService>();
        services.AddScoped<IGeneratorSnapshotService, GeneratorSnapshotService>();
        ...
        services.AddTransient<
            IValidator<ControlAllUserDevicesCommand>,
            ControlAllUserDevicesValidator
        >();
